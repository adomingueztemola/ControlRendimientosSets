...
$idCatMateriaPrima = $_abierto ? $DataAbierto[0]["idCatMateriaPrima"] : '0';
$tipo = $_abierto ? $DataAbierto[0]["tipoMatPrima"] : '0';
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <select name="materiaConcepto" <?= $disabled ?> id="materiaConcepto" onchange="guardarMateriaPrima(this)" class="form-control select2 Disabled" style="width:100%">
                                                ...
                                                foreach ($DataMateria as $key => $value) {
                                                    ...
                                                    echo "<option data-tipo='{$DataMateria[$key]["tipo"]}' $selected value='{$DataMateria[$key]["id"]}'>{$DataMateria[$key]["nombre"]}</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row" id="div-costoCza" hidden>
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" <?= $disabled ?> class="form-control Money Disabled" value="<?= $precioUnitFactPesos ?>" onchange="guardarPrecioUnitPesos(this)" name="precioPeso" id="precioPesoCza">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" <?= $disabled ?> class="form-control Money Disabled" name="tc" id="tcCza" value="<?= $tc ?>" onchange="guardarTC(this)">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" <?= $disabled ?> class="form-control Money Disabled" name="precioUSD" value="<?= $precioUnitFactUsd ?>" onchange="guardarPrecioUnitUSD(this)" id="precioUSDCza">
                                    ...
                                    <div class="row" id="div-costoPiel" hidden>
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" <?= $disabled ?> class="form-control Money Disabled" name="precioUSD" value="<?= $precioUnitFactUsd ?>" onchange="guardarPrecioUnitUSD(this)" id="precioUSDPiel">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" <?= $disabled ?> class="form-control Money Disabled" name="tc" id="tcPiel" value="<?= $tc ?>" onchange="guardarTC(this)">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" <?= $disabled ?> class="form-control Money Disabled" value="<?= $precioUnitFactPesos ?>" onchange="guardarPrecioUnitPesos(this)" name="precioPeso" id="precioPesoPiel">
                                ...
                                <fieldset class="border p-2 mt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" <?= $disabled ?> class="form-control Money Disabled" name="totalCueros" id="totalCueros" value="<?= $totalCuerosFacturados ?>" onchange="guardarCueros(this)">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label required" for="areaProv">Área Proveedor Pie<sup>2</sup>: </label>
                                            <div class="input-group mb-3">

                                                <input type="text" <?= $disabled ?> class="form-control Money Disabled" name="areaProv" id="areaProv" value="<?= $areaProvPie2 ?>" onchange="guardarAreaProv(this)">
                                                <div class="input-group-append">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" disabled class="form-control Money" name="areaWB" id="areaWB" value="<?= $areaWBPromFact ?>">
                                        </div>
                                    </div>
                                </fieldset>
...
<script src="../assets/scripts/verificaConexionInternet.js"></script>
<script>
    <?php
    ...
    function calculaAreaPromedio() {
        ...
        result = (areaProv / totalCueros).toFixed(3)
