                            ...
                            <div class="card-body" id="">
                                <form id="filtrado">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                            <label for="empaques">Set's Empacado:</label>
                                            <select class="form-control select2" style="width:100%" name="empaques" id="empaques">
                                                <option value="">Todos los Empacados</option>
                                                <option value="1">Con Set's Empacados</option>
                                                <option value="2">Sin Set's Empacados</option>
...
<script>
    ...
    function update() {
        ...
        $('#content-historial').load('../templates/Rendimiento/recalcular.php');
        clearForm("filtrado");
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Rendimiento/recalcular.php',
            data: formData,
            type: 'POST',
