...
<script>
    ...
    function update() {
        $('#content-auditorias').html('<div class="loading text-center"><img src="../assets/images/loading.gif" alt="loading" /><br/>Un momento, por favor...</div>');
        $('#content-auditorias').load('../templates/Rendimiento/auditoriasUnidades.php');
        clearForm("filtrado");
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Rendimiento/auditoriasUnidades.php',
            data: formData,
            type: 'POST',
            success: function(respuesta) {
                $('#content-auditorias').html(respuesta);
