    ...
    <table id="table-pedidos" class="table table-sm display nowrap  table-hover table-bordered">
        ...
        <tbody>
            ...
            foreach ($DataRendimiento as $key => $value) {
                ...
                $suma_areaProveedorLote += $DataRendimiento[$key]['areaProveedorLote'];
        ...
        <tfoot>
            <tr class="bg-TWM text-white">
                ...
                <td><?= formatoMil($suma_yieldInicialTeseo > 0 ? $suma_yieldInicialTeseo / $count : 0) ?></td>

                <td><?= formatoMil($suma_pzasCortadasTeseo) ?></td>
                <td><?= formatoMil($suma_setsCortadosTeseo) ?></td>
                <td><?= formatoMil($suma_yieldFinalReal > 0 ? $suma_yieldFinalReal / $count : 0) ?></td>

                <td><?= formatoMil($suma_setsRechazados > 0 ? $suma_setsRechazados / $count : 0) ?></td>

                <td><?= formatoMil($suma_porcSetsRechazoInicial > 0 ? $suma_porcSetsRechazoInicial / $count : 0) ?></td>
                <td><?= formatoMil($suma_piezasRecuperadas) ?></td>
                <td><?= formatoMil($suma_setsRecuperados) ?></td>
                <td><?= formatoMil($suma_porcRecuperacion > 0 ? $suma_porcRecuperacion / $count : 0) ?></td>
                <td><?= formatoMil($suma_porcFinalRechazo > 0 ? $suma_porcFinalRechazo / $count : 0) ?></td>
                <td><?= formatoMil($suma_setsEmpacados) ?></td>
                <td><?= formatoMil($suma_areaCrustSet > 0 ? $suma_areaCrustSet / $count : 0) ?></td>
                <td><?= formatoMil($suma_areaWBUnidad > 0 ? $suma_areaWBUnidad / $count : 0) ?></td>
