...
include("../../Models/Mdl_RendimientoEtiq.php");
...
$obj_rendimiento = new RendimientoEtiqueta($debug, $idUser);
$DataLotes = $obj_rendimiento->getLotesPreRegistradosEtiq();
...
<script src="../assets/tablas/dataTable-GestionLotesEtiq.js"></script>
