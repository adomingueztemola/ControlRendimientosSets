...
$DataM2Cza= $obj_rendimiento->getM2AutPiel($filtradoAnio);
$labels=[];
...
?>
<div height="600px">
  <canvas id="m2autopiel-chart" height="500vh" width="100%"></canvas>

</div>

<script>
    dataPiel=<?=$json_encode?>;
    labelsPielWeek=[<?=$str_semana?>];
</script>
