...
$DataLotes = $obj_rendimiento->getLotesEnAlmacen($filtradoMateria, $filtradoProcesos, $filtradoPrograma, $filtradoTipo);
?>
    ...
    <table id="table-pedidos" class="table table-sm">
        ...
        <tbody>
            ...
            foreach ($DataLotes as $key => $value) {
                $count++;
                $suma_unidades += $DataLotes[$key]['pzasTotales'];
            ...
            ?>
                <tr>
                    ...
                    <td><?= formatoMil($DataLotes[$key]['pzasTotales']) ?></td>
        ...
        <tfoot>
            <tr class="bg-TWM text-white">
                ...
                <td>-</td>
                <td>-</td>
                <td><?= formatoMil($suma_unidades) ?></td>
                <td>-</td>
                <td>-</td>
