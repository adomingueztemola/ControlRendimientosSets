...
$DataDetPedido = $obj_pedidos->getPedido($id);
$cuerosXUsar = $DataDetPedido[0]["cuerosXUsar"];
$tipoMateriaPrima = $DataDetPedido[0]["tipoMateriaPrima"];

$disabled = $cuerosXUsar <= '0' ? 'disabled' : '';
$step = $tipoMateriaPrima == '1' ? '0.01' : "1";
?>
<div class="row">
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        <div class="card-header">
            Cantidad Actual de Cueros en Pedido: <?=formatoMil($DataDetPedido[0]["cuerosXUsar"])?>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        <div class="form-check form-check-inline">
            <input <?= $disabled ?> class="form-check-input" onchange="verNotaCredito(this)" type="radio" name="tipo" id="disminucion" value="2">
