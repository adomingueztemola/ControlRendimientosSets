...
$filtradoProveedor = $proveedor != '' ? "p.idCatProveedor='$materia'" : "1=1";

$DataPedido = $obj_pedido->getPedidosExcepciones("p.estado!='1'",$filtradoFecha, $filtradoProveedor, "1=1",$filtradoMateria);
    ...
    <table id="table-pedidos" class="table table-sm">
        <thead>
            <tr class="">
                ...
                <th>Cueros Totales Disponibles</th>
                <th>Acción</th>
