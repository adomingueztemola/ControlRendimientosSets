...
<form id="formAddDevolucion">
            ...
            <table class="table table-sm">
                ...
                <tbody>
                    ...
                    if (count($DataDetDevolucion) > 0) {
                        ...
                        <td>{$f_cantidad}</td>
                        <td>
                            <input type='checkbox' name='devoluciones[]' value='{$DataDetDevolucion[$key]['id']}'>
                        </td>
                        <td><select class='form-control select2' name='inventario-{$DataDetDevolucion[$key]['id']}' id=''>
                            <option value='' selected>Selecciona Inventario</option>
                            <option value='1'>Inventario de Empacados</option>
                            <option value='2'>Inventario de Rechazados</option>
    ...
    <div class="row">
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10"></div>
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
            <div id="bloqueo-btn-dev" style="display:none">
            ...
            <div id="desbloqueo-btn-dev">
                <button type="submit" class="button btn btn-success" <?= $bloqueoBtn ?>>Devolver</button>
            </div>
        </div>
    </div>
</form>
