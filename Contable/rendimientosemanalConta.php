                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <div class="input-daterange input-group">
                                                <input type="week" class="form-control" name="date-start" value="">
                                                <div class="input-group-append">
                                                    <span class="input-group-text bg-TWM b-0 text-white">AL</span>
                                                </div>
                                                <input type="week" class="form-control" name="date-end" value="">
                                            </div>
                                        </div>
...
<script>
    ...
    function update() {
        ...
        $('#content-historial').load('../templates/Rendimiento/reporteSemanalConta.php');
        clearForm("filtrado");
