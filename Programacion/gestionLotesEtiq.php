            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 text-right mb-2">
                        <a class="btn button btn-TWM" href="configuraloteEtiq.php"><i class="fas fa-plus"></i> Agregar Lote</a>
                    </div>
                </div>
                <div class="row">
...
<script>
    ...
    function update() {
        ...
        $('#content-lotes').load('../templates/Rendimiento/cargaGestionLotesEtiq.php');
