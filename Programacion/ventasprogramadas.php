                                ...
                                <form id="filtrado">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 pt-4 mt-1">
                                            <button type="submit" class="btn button btn-TWM"> Filtrar</button>
                                        </div>
                                    </div>
                                </form>
...
<script>
    ...
    function update() {
        cargaContenido("content-ventas", "../templates/Ventas/cargaVentasProgramadas.php", '1')
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Ventas/cargaVentasProgramadas.php',
            data: formData,
            type: 'POST',
