                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            ...
                                            <select class="form-control select2" style="width:100%" name="procesos">
                                                ...
                                                foreach ($DataProceso as $key => $value) {
                                                    echo "<option value='{$DataProceso[$key]['id']}'>{$DataProceso[$key]['nombre']}</option>";
                                                }
                                                ?>
                                            </select>
...
<script>
    ...
    function update() {
        ...
        $('#content-almacen').load('../templates/Almacen/lotesDisponibles.php');
        clearForm("filtrado");
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Almacen/lotesDisponibles.php',
            data: formData,
            type: 'POST',
