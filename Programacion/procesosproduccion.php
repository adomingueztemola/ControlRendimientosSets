                    ...
                    <div class="col-lg-4 col-md-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="card border">
                            <div class="card-body" id="">
                                <form id="formAddProcesos">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="form-label required" for="proceso">Ingresa Proceso:</label>
                    ...
                    <div class="col-lg-8  col-md-8 col-sm-12 col-xs-12">
                        <div class="card border">
                            <div class="card-body">
                                ...
                                <div class="table-responsive" id="content-procesos">
...
<script>
    ...
    function update() {
        $('#content-procesos').html('<div class="loading text-center"><img src="../assets/images/loading.gif" alt="loading" /><br/>Un momento, por favor...</div>');
        $('#content-procesos').load('../templates/Extras/procesosProduccion.php');


    }

    /********** ENVIO DE UNA PROCESOS ***********/
    $("#formAddProcesos").submit(function(e) {
        e.preventDefault();
        formData = $(this).serialize();
        $.ajax({
            url: '../Controller/procesos.php?op=agregarproc',
            data: formData,
            type: 'POST',
    ...
    /********CAMBIA ESTATUS DE LOS PROCESOS**********/
    function cambiaEstatus(id, EstatusActual) {
        $.post("../Controller/procesos.php?op=cambiaestatus", {
                id: id,
 ...
 function filtrado(idBusqueda) {
        ...
        $.ajax({
            type: 'POST',
            url: '../templates/Extras/procesosProduccion.php',
            data: {id:idBusqueda},
            success: function(respuesta) {
                $('#content-procesos').html(respuesta);
