                    ...
                    <div class="col-lg-4 col-md-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="card border">
                            <div class="card-body" id="">
                                <form id="formAddProveedores">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="form-label required" for="proveedor">Ingresa Proveedor:</label>
                                            <input type="text" class="form-control Mayusculas" autocomplete="off" required name="proveedor" id="proveedor">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                    ...
                    <div class="col-lg-8  col-md-8 col-sm-12 col-xs-12">
                        <div class="card border">
                            <div class="card-body">
                                ...
                                <div class="table-responsive" id="content-proveedores">
...
<script>
    ...
    function update() {
        $('#content-proveedores').html('<div class="loading text-center"><img src="../assets/images/loading.gif" alt="loading" /><br/>Un momento, por favor...</div>');
        $('#content-proveedores').load('../templates/Extras/proveedores.php');


    }

    /********** ENVIO DE UNA PROVEEDORES ***********/
    $("#formAddProveedores").submit(function(e) {
        e.preventDefault();
        formData = $(this).serialize();
        $.ajax({
            url: '../Controller/proveedores.php?op=agregarprov',
            data: formData,
            type: 'POST',
    ...
    function cambiaEstatus(id, EstatusActual) {
        $.post("../Controller/proveedores.php?op=cambiaestatus", {
                id: id,
 ...
 function filtrado(idBusqueda) {
        ...
        $.ajax({
            type: 'POST',
            url: '../templates/Extras/proveedores.php',
            data: {id:idBusqueda},
            success: function(respuesta) {
                $('#content-proveedores').html(respuesta);
