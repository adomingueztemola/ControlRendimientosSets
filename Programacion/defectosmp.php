                    ...
                    <div class="col-lg-4 col-md-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="card border">
                            <div class="card-body" id="">
                                <form id="formAddDefectos">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="form-label required" for="defectos">Ingresa defectos:</label>
                                            <input type="text" class="form-control Mayusculas" autocomplete="off" required name="defecto" id="defecto">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                    ...
                    <div class="col-lg-8  col-md-8 col-sm-12 col-xs-12">
                        <div class="card border">
                            <div class="card-body">
                                ...
                                <div class="table-responsive" id="content-defectos">
...
<script>
    ...
    function update() {
        $('#content-defectos').html('<div class="loading text-center"><img src="../assets/images/loading.gif" alt="loading" /><br/>Un momento, por favor...</div>');
        $('#content-defectos').load('../templates/Extras/defectosMp.php');


    }

    /********** ENVIO DE DEFECTOS ***********/
    $("#formAddDefectos").submit(function(e) {
        e.preventDefault();
        formData = $(this).serialize();
        $.ajax({
            url: '../Controller/Defectos.php?op=agregardefec',
            data: formData,
            type: 'POST',
    ...
    function cambiaEstatus(id, EstatusActual) {
        $.post("../Controller/Defectos.php?op=cambiaestatus", {
                id: id,
 ...
 function filtrado(idBusqueda) {
        ...
        $.ajax({
            type: 'POST',
            url: '../templates/Extras/defectosMp.php',
            data: {id:idBusqueda},
            success: function(respuesta) {
                $('#content-defectos').html(respuesta);
