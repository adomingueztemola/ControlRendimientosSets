...
<script>
    ...
    function update() {
        $('#content-reporte').html('<div class="loading text-center"><img src="../assets/images/loading.gif" alt="loading" /><br/>Un momento, por favor...</div>');
        $('#content-reporte').load('../templates/Ventas/reporteLotesXVender.php');
        clearForm("filtrado");
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Ventas/reporteLotesXVender.php',
            data: formData,
            type: 'POST',
            success: function(respuesta) {
                $('#content-reporte').html(respuesta);
