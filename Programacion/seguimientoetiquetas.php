                                ...
                                <form id="filtrado">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                            <label for="estado">Lotes Etiqueta/Calzado:</label>
                                            <select class="form-control select2" style="width:100%" name="estado" id="estado">
                                                <option value="">Todos los Lotes</option>
                                                <option value="1">Lotes con Pedido</option>
                                                <option value="2">Lotes sin Pedido</option>
...
<script>
    ...
    function update() {
        ...
        $('#content-historial').load('../templates/Pedidos/seguimientoEtiquetas.php');
        clearForm("filtrado");
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Pedidos/seguimientoEtiquetas.php',
            data: formData,
            type: 'POST',
