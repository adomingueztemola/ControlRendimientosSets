    ...
    <div class="row h3">
        <div class="col-12">
            <table class="table table-sm table-bordered bg-white">
                ...
                <tbody>
                    <tr>
                        <td>Manual de Usuario de Producción Set's/ Piel Automotriz.</td>
                        <td class="text-center"><a href="doctos/Manuales/USUARIO PRODUCCION DE SETS PIEL AUTOMOTRIZ Rev1.2.pdf" target="_blank" rel="noopener noreferrer">
                    ...
                    <tr>
                        <td>Manual de Usuario de Registro de Medición</td>
                        <td class="text-center"><a href="doctos/Manuales/USUARIO REGISTRO MEDIDOR Rev1.2.pdf" target="_blank" rel="noopener noreferrer">
                            <i class="fas fa-book"></i>
                        </a></td>
                    </tr>
                </tbody>
