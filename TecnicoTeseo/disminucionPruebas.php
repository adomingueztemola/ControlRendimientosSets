                        ...
                        <div class="card border">
                            <div class="card-body" id="">
                                <ul class="nav nav-pills m-t-30 m-b-30">
                                    <li class="nav-item"> <a href="#areaTrabajo" onclick='verModulo(4)' class="nav-link active" data-toggle="tab" aria-expanded="false"><i class="fas fa-flask"></i>Disminución por Pruebas</a> </li>
