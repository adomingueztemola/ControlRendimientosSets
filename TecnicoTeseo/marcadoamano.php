...
<script>
    ...
    function update() {
        ...
        $('#content-seguimiento').load('../templates/MarcadoAMano/seguimientoMarcado.php');

    }

    /**************************************** ENVIO DE INICIO DE CONTEO ****************************************************/
    $("#formInicioConteo").submit(function(e) {
        e.preventDefault();
        formData = $(this).serialize();
        $.ajax({
            url: '../Controller/lotesOPF.php?op=inicioconteo',
            data: formData,
            type: 'POST',
            success: function(json) {
                ...
                if (resp[0] == 1) {
                    ...
                    clearForm("formInicioConteo")
                    $("#conteoModal").modal('hide');
                    setTimeout(() => {
                        update()
                    }, 1000);
