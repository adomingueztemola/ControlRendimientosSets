                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                            ...
                                            <select class="form-control select2" style="width:100%" name="estado" id="estado">
                                                ...
                                                <option value="1">Aumento del % de Rechazo</option>
                                                <option value="2">Disminución del % de Rechazo</option>
...
<script>
    ...
    function update() {
        ...
        $('#content-inventario').load('../templates/Almacen/inventarioRechazadas.php');
        clearForm("filtrado");
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Almacen/inventarioRechazadas.php',
            data: formData,
            type: 'POST',
