...
class Seguridad
{
	...
	public function customizerMobil()
	{
		...
		if ($cantPym == 1) {
			$linkLog = ($this->linkArea != '') ? 'programacion.php' : 'index.php';
			//----------------devBug------------------------------
			if ($GLOBALS['devBug'] == 1) {
	...
	public function creaHeaderConMenu()
	{
		...
		echo '<li class="nav-item dropdown border-right">
		<a class="nav-link dropdown-toggle waves-effect waves-dark" id="dropdownAlerta"  data-toggle="" onclick="abrirDropdown()"
			aria-haspopup="true" aria-expanded="false">
			<i class="mdi mdi-bell-outline font-22"></i>
			<span class="badge badge-pill badge-info noti" id="total-menu">0</span>
		</a>
		<div id="dropdownContent" class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown">
			<span class="with-arrow">
				<span class="pyme"></span>
			</span>
			<ul class="list-style-none">
				<li>
					<div class="drop-title">
						<h4 class="m-b-0 m-t-5" id="total-notifications">0</h4>
						<span class="font-light">Notificacion(es)<span id="loading-notifications"></span></span>
					</div>
				</li>
				<li>
				...
				<!--<li>
					<a class="nav-link text-center m-b-5 text-dark" href="javascript:void(0);">
						<strong>Visualizar todas las alertas</strong>
