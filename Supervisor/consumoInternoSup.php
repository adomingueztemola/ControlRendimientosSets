...
<script>
    ...
    function update() {
        $('#content-interno').html('<div class="loading text-center"><img src="../assets/images/loading.gif" alt="loading" /><br/>Un momento, por favor...</div>');
        $('#content-interno').load('../templates/Ventas/consumoInterno.php');
        clearForm("filtrado");
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Ventas/consumoInterno.php',
            data: formData,
            type: 'POST',
            success: function(respuesta) {
                $('#content-interno').html(respuesta);
