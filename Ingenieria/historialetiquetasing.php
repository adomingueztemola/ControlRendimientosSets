                            ...
                            <div class="card-body" id="">
                                <form id="filtrado">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                            <label for="area">Área Final:</label>
                                            <select class="form-control select2" style="width:100%" name="area" id="area">
                                                <option value="">Todos las áreas finales</option>
                                                <option value="1">Con Área Final</option>

                                                <option value="2">Sin Área Final</option>
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                            ...
                                            <select class="form-control select2" style="width:100%" name="tipoVenta" id="tipoVenta">
                                                <option value="">Todos las ventas</option>
...
<script>
    ...
    function update() {
        ...
        $('#content-historial').load('../templates/Rendimiento/historialEtiquetas.php');
        clearForm("filtrado");
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Rendimiento/historialEtiquetas.php',
            data: formData,
            type: 'POST',
