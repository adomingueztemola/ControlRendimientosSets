...
function cambioDeLote(selectLote) {
  ...
  //DESGLOSE DEL TOTAL DE PIEZAS DE RECUPERADAS
  $("#total_12").text(0);
  $("#total_9").text(0);
  $("#total_6").text(0);
  $("#total_3").text(0);
  ...
  switch (tipo) {
    ...
    case "3": //RECUPERADOS REGISTRADOS
      ...
      if (completedCaja == "1") {
        ...
        $("#total_6").text(pza6);
        $("#total_3").text(pza3);
        //ALERTA ACERCA DE LAS PZAS QUE NO ALCANZAN PARA CERRAR CAJAS

        if (pza12 < $("#pzas_12").val()) {
          document.getElementById("pzas_12").style.borderColor = "red";
        } else {
          document.getElementById("pzas_12").style.borderColor = "none";
        }
        if (pza6 < $("#pzas_06").val()) {
          document.getElementById("pzas_06").style.borderColor = "red";
        } else {
          document.getElementById("pzas_06").style.borderColor = "none";
        }
        if (pza9 < $("#pzas_09").val()) {
          document.getElementById("pzas_09").style.borderColor = "red";
        } else {
          document.getElementById("pzas_09").style.borderColor = "none";
        }
        if (pza3 < $("#pzas_03").val()) {
          document.getElementById("pzas_03").style.borderColor = "red";
        } else {
          document.getElementById("pzas_03").style.borderColor = "none";
        }
      }
      break;
    default:
