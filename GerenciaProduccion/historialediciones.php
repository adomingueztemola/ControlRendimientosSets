                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                            ...
                                            <select class="form-control select2" style="width:100%" name="estado" id="estado">
                                                <option value="">Todos las Solicitudes</option>
                    ...
                    <div class="col-lg-12 col-md-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card border">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="content-solicitudes"></div>
...
<script>
    ...
    function update() {
        $('#content-solicitudes').html('<div class="loading text-center"><img src="../assets/images/loading.gif" alt="loading" /><br/>Un momento, por favor...</div>');
        $('#content-solicitudes').load('../templates/Ediciones/historialEdiciones.php');
        clearForm("filtrado");
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Ediciones/historialEdiciones.php',
            data: formData,
            type: 'POST',
            success: function(respuesta) {
                $('#content-solicitudes').html(respuesta);
