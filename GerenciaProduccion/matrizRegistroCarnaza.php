                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                                            ...
                                            <select class="form-control select2" style="width:100%" name="estado" id="estado">
                                                ...
                                                <option value="2">Captura Finalizada</option>
                                        ...
                                        <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                                            ...
                                            <select class="form-control select2" style="width:100%" name="proceso" id="proceso">
                                                <option value="">-</option>
                                                <?php
                                                $DataProceso = $obj_proceso->getProcesos("pr.estado='1'", "pr.tipo='2'");
...
<script>
    ...
    function update() {
        ...
        $('#content-historial').load('../templates/Rendimiento/historialPielGerencia.php');
        clearForm("filtrado");
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Rendimiento/historialPielGerencia.php',
            data: formData,
            type: 'POST',
