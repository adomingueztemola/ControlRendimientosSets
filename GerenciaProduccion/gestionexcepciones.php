...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <div class="col-lg-12 col-md-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card border">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="content-excepciones"></div>
        ...
        <div class="modal" id="ModalAceptarExcepciones" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header text-white bg-TWM">
                        <h5 class="modal-title">Aceptación de Excepción para Ajuste de Inventario</h5>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form id="formAceptarExcepcion">
                        ...
                        <div class="modal-footer">
                            ...
                            <div id="desbloqueo-btn-1">
                                <button type="submit" id="btn-envioExcepcion" class="btn btn-success">Aceptar Excepción</button>
...
<script>
    ...
    function update() {
        $('#content-excepciones').html('<div class="loading text-center"><img src="../assets/images/loading.gif" alt="loading" /><br/>Un momento, por favor...</div>');
        $('#content-excepciones').load('../templates/Excepciones/excepciones.php');
        clearForm("filtrado");
