                                ...
                                <form id="filtrado">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <select style="width:100%" class="form-control select2" name="programa" id="programa">
...
<script>
    ...
    function update() {
        ...
        $('#content-ventas').load('../templates/Ventas/ventasSetsGenerales.php');
        clearForm("filtrado");
    ...
    $("#filtrado").submit(function(e) {
        ...
        $.ajax({
            url: '../templates/Ventas/ventasSetsGenerales.php',
            data: formData,
            type: 'POST',
